...
const description = "Silly Ghost Family is a collection of 10,000 unique NFTs automatically generated with an algorithm that combines all five layers with different rarities (background, body, mouth, eyes, hat). Each of these layers was drawn by hand ;)";
...
const extraMetadata = {
  external_url: "https://sillyghostfamily", // Replace with your website or remove this line if you do not have one.
};
