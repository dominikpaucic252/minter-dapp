const contractAddress = "0x509A3ffaB2A9cb3C9c0F84b358be21643893F46A"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Silly Ghost Club NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Silly Ghost Club NFT project is a unique digital collection, on the Polygon Blockchain. 10,000 ghosts have been automatically generated using an algorithm, each ghost is unique, with different characteristics and rarities. Own a Silly Ghost and surf the crypto revolution!';
